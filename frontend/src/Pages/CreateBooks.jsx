...
function CreateBooks() {
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? <Spinner/> : ''}
      <div className='flex flex-col border-2 border-green-400 rounded-xl w-[600px] p-4 mx-auto shadow-xl'>
        <div className='my-4'>
        ...
        <button className='p-2 bg-green-500 w-full my-8 rounded-md text-white hover:bg-green-600 text-xl shadow-xl ' onClick={handleSaveBook}>
            Save
        </button>
      </div>
    </div>
